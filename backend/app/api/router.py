from app.api.routes import admin, ai_advice, analysis, auth, dashboard, exercises, feedback, files, health, qrcode, realtime, reference_videos, reports, sessions, videos, wechat
