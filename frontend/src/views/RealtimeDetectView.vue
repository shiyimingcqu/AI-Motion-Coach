...
const DEFAULT_EXERCISE_OPTIONS: ExerciseOption[] = [
  ...
  },
  {
    key: "bench_press",
    name: "卧推",
    description: "评估推起幅度、腕肘对齐、肩部轨迹和左右同步。",
    supported_metrics: ["count", "valid_count", "score"],
    core_angles: ["肘角", "肩角", "腕肘对齐", "左右对称差"],
    core_feature_keys: ["elbow_angle", "shoulder_angle", "wrist_elbow_alignment", "symmetry_diff"],
  },
  {
    key: "barbell_squat",
    name: "杠铃深蹲",
    description: "评估下蹲深度、躯干控制、手腕近似杠铃路径和左右膝稳定。",
    supported_metrics: ["count", "valid_count", "score", "depth_ratio"],
    core_angles: ["膝角", "髋角", "躯干倾斜角", "杠铃路径偏移", "左右膝差"],
    core_feature_keys: ["knee_angle", "hip_angle", "trunk_angle", "bar_path_offset", "knee_symmetry_diff"],
  },
  {
    key: "dumbbell_fly",
    name: "哑铃飞鸟",
    description: "评估飞鸟打开幅度、肘部微屈保持和左右轨迹对称。",
    supported_metrics: ["count", "valid_count", "score"],
    core_angles: ["肩外展角", "肘部保持角", "手腕轨迹宽度", "左右对称差"],
    core_feature_keys: ["shoulder_abduction_angle", "elbow_bend_angle", "wrist_path_width", "symmetry_diff"],
  },
  {
    key: "lat_pulldown",
    name: "高位下拉",
    description: "评估下拉幅度、手腕高度、躯干后仰和左右同步。",
    supported_metrics: ["count", "valid_count", "score"],
    core_angles: ["肘角", "肩内收角", "手腕高度", "躯干倾斜角", "左右对称差"],
    core_feature_keys: ["elbow_angle", "shoulder_adduction_angle", "wrist_height", "trunk_angle", "symmetry_diff"],
  },
  {
    key: "dumbbell_shoulder_press",
    name: "哑铃推肩",
    description: "评估推举伸展、肩部上举、手腕肩部对齐和核心稳定。",
    supported_metrics: ["count", "valid_count", "score"],
    core_angles: ["肘角", "肩角", "手腕肩部偏移", "躯干倾斜角", "左右对称差"],
    core_feature_keys: ["elbow_angle", "shoulder_angle", "wrist_over_shoulder_offset", "trunk_angle", "symmetry_diff"],
  },
  {
    key: "dumbbell_curl",
    name: "哑铃弯举",
