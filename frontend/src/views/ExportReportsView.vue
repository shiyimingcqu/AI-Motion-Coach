...
onMounted(async () => {
  try {
    ...
    summary.value = {
      ...
      total_calories: 0, total_count: 0, valid_count: 0, error_count: 0,
...
.summary-card-grid { display: grid; grid-template-columns: repeat(5, 1fr); gap: 16px; }
